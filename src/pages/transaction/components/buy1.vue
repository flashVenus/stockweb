            ...
            <div class="buy-box" style="margin-top: 15px">
              ...
              >
                <div class="buy-item" style="display: flex">
                  ...
                  <span
                    style="font-size: 12px; color: #b12525"
                    :class="
                      detail.hcrate < 0
                        ? 'green price'
                        : detail.hcrate > 0
                  ...
                  <div>
                        ...
                        >
                          <div>
                            <el-button
                              ...
                              :key="item.key"
                              @click="selectBuyTypeFun(item.value)"
                              :type="
                                form.buyType == item.value ? 'primary' : ''
                              "
                            >
                              {{ item.label }}
                            </el-button>
                    ...
                    >
                      <div class="dialog-iframe">
                        ...
                        >
                          <p
                            v-for="item in tradeAgreeText.split('。')"
                            :key="item"
                          >
                            {{ item }}。
                          </p>
                        ...
                        <div
                          slot="footer"
                          class="text-center dialog-footer clearfix"
                        >
                          <el-button type="primary" @click="agreeTrade"
                            >我已阅读并同意{{
                              siteInfo.tradeAgreeTitle
                            }}</el-button
                          >
                        </div>
                      </div>
              ...
              >
                ...
                <div>
                  ...
                  <el-row class="buy-item" v-if="!isqihuo">
                    ...
                    <el-col :span="12">
                      <span class="keyong"
                        >可用资金：{{ $store.state.userInfo.enableAmt }}元</span
                      >
                    </el-col>
                  </el-row>
                  <el-row class="buy-item" v-if="isqihuo">
                  ...
                  <p class="prompt clearfix" v-if="isqihuo">
                    ...
                    <span class="keyong"
                      >可用资金：{{
                        this.$store.state.userInfo.userFuturesAmt
                      }}元</span
                    >
                  </p>
                  <el-row class="buy-item" style="font-size: 10px">
                    ...
                    ></el-checkbox
                    >我同意
                    <a href="javascript:;" @click="tradeDialogVisible = true"
...
export default {
  ...
  computed: {
    ...
    gupiaoTotal() {
      if (this.form.buyType == 1) {
        return (this.detail.nowPrice * (this.form.buyNum || 0) * 100).toFixed(
          2
        );
      } else {
        return (
  ...
  methods: {
    ...
    selectCwFun(value) {
      ...
      this.form.buyNum = Math.floor(
        userAmt / Number(value) / 100 / this.detail.nowPrice
      );
    },
      ...
      if (result.status === 0) {
        if (result.data.list.length > 0) {
          ...
          if (
            ...
            this.form.subaccountNumber =
              this.subaccountList[0].subaccountNumber;
          }
        }
      } else {
        this.$message.error(result.msg);
        ...
        if (valid) {
          ...
          if (this.$route.query.code.indexOf("hf_") != -1) {
            ...
            let opts = {
              ...
              triggerPrice:
                this.form.buyType == 2 ? this.form.triggerPrice : undefined,
            };
