	...
	<el-container class="user-center">
		...
		<div class="usercot">
			<el-container class="main-wrapper">
				...
				<el-main>
					<div data-v-5d396ccb class="user-center-title" style="text-align: left;margin: 15px 10px 10px 10px;" v-if="$store.state.userInfo.hasWithdrawPwd == true">
						<span data-v-5d396ccb class="iconfont icon-you" style="color: rgb(193, 24, 21); font-size: 18px; margin-right: 10px;"></span>
						修改资金密码
					</div>
                    <div data-v-5d396ccb class="user-center-title" style="text-align: left;margin: 15px 10px 10px 10px;" v-else>
						<span data-v-5d396ccb class="iconfont icon-you" style="color: rgb(193, 24, 21); font-size: 18px; margin-right: 10px;"></span>
						绑定资金密码
					</div>
							...
							<div class="box-contain clearfix">
								...
								<div class="auth-box">
									<el-form :hide-required-asterisk='true' :model="form" label-width="100px" ref="ruleForm" :rules="rule" class="demo-form-inline">
										<el-form-item prop="oldPwd" v-if="$store.state.userInfo.hasWithdrawPwd == true">
